...
<body>
  ...
  1:<input type="range" min="0" max="180" class="slider" id="1" oninput="updateSliderPWM(this)"/><br>
  2:<input type="range" min="0" max="180" class="slider" id="2" oninput="updateSliderPWM(this)"/><br>
  3:<input type="range" min="0" max="180" class="slider" id="3" oninput="updateSliderPWM(this)"/><br>
  <script>
